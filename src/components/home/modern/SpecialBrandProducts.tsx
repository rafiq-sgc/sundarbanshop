...
const products = [
  { id: 1, name: 'Premium Cotton T-Shirt', price: 29.99, originalPrice: 39.99, image: '/images/products/product-1.jpg', rating: 5 },
  { id: 2, name: 'Classic Denim Jeans', price: 79.99, originalPrice: 99.99, image: '/images/products/product-2.jpg', rating: 5 },
  { id: 3, name: 'Sports Running Shoes', price: 89.99, originalPrice: 109.99, image: '/images/products/product-3.jpg', rating: 5 },
  { id: 4, name: 'Leather Crossbody Bag', price: 129.99, originalPrice: 159.99, image: '/images/products/product-4.jpg', rating: 5 },
  { id: 5, name: "Kids Cotton Combo Set", price: 199.99, originalPrice: 249.99, image: '/images/products/product-5.jpg', rating: 5 },
  { id: 6, name: "Men's Trendy Formal Shoes", price: 169.99, originalPrice: 199.99, image: '/images/products/product-6.jpg', rating: 5 },
]

export default function SpecialBrandProducts() {
  return (
    <section className="py-4 sm:py-6 bg-white">
      <div className="container">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 text-center">Our Special Brand Products</h2>
